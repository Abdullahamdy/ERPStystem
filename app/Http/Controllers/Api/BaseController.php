...
abstract class BaseController extends Controller
{
     ...
     * @return JsonResponse
     */
    protected function handleResponse($data = null, $message = null, int $status_code = self::HTTP_OK): JsonResponse
    {
     ...
     * @return JsonResponse
     */
    protected function respondData($data, string $message = null, int $status_code = self::HTTP_OK): JsonResponse
    {
