            ...
            $menu->dropdown(
                ...
                function ($sub) use ($enabled_modules) {
                    ...
                    $sub->url(
                        ...
                        '- المخزن الفرعي ',
                        ['icon' => 'fa fas fa-utensils', 'active' => request()->segment(2) == 'recipe']
                    );
                    $sub->url(
                        url('modules/heads-stories'),
                        '- المخزن الرئيسي ',
            ...
            $menu->dropdown(
                ...
                function ($sub) {
                    ...
                    $sub->url(
                        url('modules/tables'),
                        '- الإضافات',
                        ['icon' => 'fa fas fa-pizza-slice', 'active' => request()->segment(2) == 'tables']
                    );
                    $sub->url(
                        url('bookings'),
                        '- الحجز',
                        ['icon' => 'fa fas fa-calendar-check', 'active' => request()->segment(1) == 'bookings']
                    );
                    $sub->url(
