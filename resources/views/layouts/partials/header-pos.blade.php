...
<div class="col-md-12 no-print pos-header">
  ...
  <div class="row">
    ...
    <div class="col-md-6">
      ...
      <button type="button" class="btn btn-danger btn-flat m-6 btn-xs m-5 pull-right" id="return_sale" title="@lang('lang_v1.sell_return')" data-toggle="popover" data-trigger="click" data-content='<div class="m-8">
        <input type="text" class="form-control a" placeholder="@lang("sale.invoice_no")" id="send_for_sell_return_invoice_no">
      </div>
      <div class="w-100 text-center b"><button type="button" class="btn btn-danger" id="send_for_sell_return">@lang("lang_v1.send")</button></div>' data-html="true" data-placement="bottom">
