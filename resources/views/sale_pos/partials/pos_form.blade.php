...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        // Get the select dropdown and restaurant module span elements
        const typesOfServiceDropdown = document.getElementById('types_of_service_id');
        const restaurantModuleSpan = document.getElementById('restaurant_module_span');

        // Function to show/hide restaurant module
        function toggleRestaurantModule() {
            const selectedValue = typesOfServiceDropdown.value;
