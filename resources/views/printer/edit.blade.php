...
@section('content')
    ...
    <section class="content">
        {!! Form::open([
            'url' => action('PrinterController@update', [$printer->id]),
            'method' => 'PUT',
            'id' => 'add_printer_form',
        ]) !!}
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            {!! Form::select('connection_type', $connection_types, $printer->connection_type, [
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            {!! Form::select('product_ids[]', $products, $selectedProductIds, [
                                'class' => 'form-control select2',
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            {!! Form::select('capability_profile', $capability_profiles, $printer->capability_profile, [
                                'class' => 'form-control select2',
                            ]) !!}
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            {!! Form::number('char_per_line', $printer->char_per_line, [
                                'class' => 'form-control',
                                'required',
                    ...
                    <div class="col-sm-12" id="ip_address_div">
                        <div class="form-group">
                            ...
                            {!! Form::text('ip_address', $printer->ip_address, [
                                'class' => 'form-control',
                                'required',
                    ...
                    <div class="col-sm-12 hide" id="path_div">
                        <div class="form-group">
                            ...
                            <span class="help-block">
                                <b>Connection Type Windows: </b> The device files will be along the lines of
                                <code>LPT1</code> (parallel) or <code>COM1</code> (serial). <br />
                                <b>Connection Type Linux: </b> Your printer device file will be somewhere like
                                <code>/dev/lp0</code> (parallel), <code>/dev/usb/lp1</code> (USB), <code>/dev/ttyUSB0</code>
